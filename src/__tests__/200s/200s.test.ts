import * as Responses200s from "../../200s";
...
{
    const defaultResponse = defaultParams[200][responseName];
...
for (const [responseName, ResponseModel] of Object.entries(Responses200s))
{
    // Constructor
