import * as Responses100s from "../../100s";
...
{
    const defaultResponse = defaultParams[100][responseName];
...
for (const [responseName, ResponseModel] of Object.entries(Responses100s))
{
    // Constructor
