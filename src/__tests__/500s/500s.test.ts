import * as Responses500s from "../../500s";
...
{
    const defaultResponse = defaultParams[500][responseName];
...
for (const [responseName, ResponseModel] of Object.entries(Responses500s))
{
    // Constructor
